...
docker tag rancherlabs/website:build ${aliyun_registry}/${images_namespace}/website:build
docker push registry.cn-shanghai.aliyuncs.com/${images_namespace}/website:build